    ...
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          ...
          <Button className="!text-indigo-700 font-semibold flex justify-center items-center mx-auto max-w-40"  
           onClick={openModal}>Add To List</Button>
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-14">
          ...
          <div className="text-center">
            ...
            Disclaimer: AutoTempest is not affiliated with or endorsed by craigslist, AutoTrader (.com or .ca), 
            or Kijiji which are registered trademarks of their respective holders.
            </p>
